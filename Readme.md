...
[travis-image]: https://travis-ci.com/htmlacademy-animation/{{userId}}-{{projectName}}.svg?branch=master
[travis-url]: https://travis-ci.com/htmlacademy-animation/{{userId}}-{{projectName}}
[dependency-image]: https://david-dm.org/htmlacademy-animation/{{userId}}-{{projectName}}/dev-status.svg?style=flat-square
[dependency-url]: https://david-dm.org/htmlacademy-animation/{{userId}}-{{projectName}}?type=dev
